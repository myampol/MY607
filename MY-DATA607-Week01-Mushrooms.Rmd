...
```{r obtain-the-data-from-UCI}
setwd("C:/Users/Michael/Dropbox/priv/CUNY/MSDS/201809-Fall/DATA607_Andy_Sabrina/Week01/Week01-AssignmentLab-MushroomDatabase")
...
(There is probably a cleaner way to do this, but this is what I can do for now)

```{r pastearray-function}
...
(I had to do set this up externally because I couldn't get the proper processing of the quotation marks in R)
```{r rename-the-factors}
