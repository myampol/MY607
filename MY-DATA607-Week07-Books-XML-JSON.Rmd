...
### my_books_html_file <- 'Examples/ThreeBooks.html'
...
### if loading from local file
#my_books_xml_file <- 'Examples/ThreeBooks.xml'
...
### if loading from local file
###my_books_json_file <- 'Examples/ThreeBooks.json'
...
## Conclusion:  All three data frames are identical.
